...
public class Node {
	...
	// default constructor
	public Node() {
		this(new CelebrityRecord()); // storing null Record objects
	}

	public Node(CelebrityRecord data) {
		this(data, null, null);
	}

	public Node(CelebrityRecord data, Node leftChild, Node rightChild) {
		_data = data;
		setLeftChild(leftChild);
		setRightChild(rightChild);
	}

	public CelebrityRecord getData() {
		return _data;
	}

	public void setData(CelebrityRecord data) {
		_data = data;
	}
